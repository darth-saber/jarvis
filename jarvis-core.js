...
class JarvisCore {
    ...
    init() {
        ...
        // Welcome message
        setTimeout(() => {
            this.speak("Good evening. I'm Jarvis, your personal AI assistant. What can I help you accomplish today?");
        }, 1000);
    }
    ...
    processCommand(command) {
        ...
        // Process the command
        const response = this.executeCommand(normalizedCommand);
